...
all: main.o utilidades.o tela_cadastro.o tela_principal.o tela_inicial.o manipulacao_csv.o tela_edicao_lista.o tela_edicao.o
	$(CC) main.o utilidades.o manipulacao_csv.o tela_cadastro.o tela_principal.o tela_inicial.o tela_edicao_lista.o tela_edicao.o -o cadastro.exe

unix: main.o utilidades.o tela_cadastro.o tela_principal.o tela_inicial.o manipulacao_csv.o tela_edicao_lista.o tela_edicao.o
	$(CC) main.o utilidades.o manipulacao_csv.o tela_cadastro.o tela_principal.o tela_inicial.o tela_edicao_lista.o tela_edicao.o -o cadastro
